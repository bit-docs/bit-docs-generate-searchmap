...
var docMap = {
		  "can-core": {
		    ...
		    "description": 'The best, most hardened and generally useful libraries in <a href="#">CanJS</a>.\n',
		    "name": "can-core",
		    "title": "Core",
		    "type": "page",
		    "parent": "canjs",
...
describe("bitDocs.generators.searchMap",function(){
	...
	it("(bitDocs.generators.searchMap.searchMap) Strips HTML from the description", function(done){
		var descriptionShouldEqual = 'The best, most hardened and generally useful libraries in <a href="#">CanJS</a>.\n';
		docMapPromise.then(function(docMap){
